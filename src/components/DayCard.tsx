...
const DayCard = ({ day, hijriDate, onClick, isSelected }: DayCardProps) => {
  return (
    <button
      onClick={onClick}
      className={`gold-border card-hover rounded-xl p-3 sm:p-4 flex flex-col items-center justify-center gap-1 sm:gap-2 min-h-[80px] sm:min-h-[100px] cursor-pointer group relative overflow-hidden transition-all duration-300 ${
        isSelected
